...
dir_1 = os.path.join(rootDir, 'mapel', 'controllers')
dir_2= os.path.join(rootDir, 'mapel', 'elections')
dir_3 = os.path.join(rootDir, 'mapel', 'results')
...
setup(
    ...
    package_data={'mapel': [dir_1 + '/*.txt', dir_2 + '/*.txt', dir_3 + '/*.txt']},
