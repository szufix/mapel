...
# def print_matrix_old(experiment=None, scale=1., distance_name='',
#                      metric_name='', saveas="matrix", show=True,
...
#
#     mapping = [i for i in range(experiment.num_families) for _ in
#                range(experiment.families[i].size)]
#
#     for i in range(experiment.num_elections):
#         limit = i + 1
#         if self_distances:
...
# def print_param_vs_distance(experiment_id, values="", scale="none",
#                             metric="positionwise", saveas="correlation",
...
#
#     el.generate_elections(experiment_id,
#                           election_experiment=election_experiment,
#                           election_id=election_2_id,
#                           num_voters=experiment.num_voters,
#                           num_candidates=experiment.num_candidates,
#                           param_1=x)
...
#         distances[i] = metr.get_distance(election_1, election_2,
...
#                    color=experiment.families[k].color,
#                    label=experiment.families[k].label,
#                    alpha=experiment.families[k].alpha, s=9,
#                    marker=experiment.families[k].marker)
#         left = right
#
#     title_text = str(experiment.num_voters) + " voters  x  " + str(
#         experiment.num_candidates) + " candidates"
#     pear_text = "PCC = " + str(pear)
#     add_text = ax.text(0.7, 0.8, pear_text, transform=ax.transAxes)
#     plt.title(title_text)
#     plt.xlabel(xlabel_text)
#     plt.ylabel(ylabel_text)
#     file_name = os.path.join(os.getcwd(), "images", "correlation",
#                              str(saveas) + '_' + tag + ".png")
...
# def excel_super(experiment_id, values="", scale="none", metric="positionwise",
#                 saveas="correlation",
#                 show=True, target='identity', ylabel_text=''):
#     num_elections = 1000
#
...
#             distances[i] = metr.get_distance(experiment_id, distance_name,
#                                              elections_ids, metric_type)
#
