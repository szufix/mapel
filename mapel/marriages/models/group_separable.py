...
def generate_symmetric_votes(num_agents=None, params=None):
    ...
    # order votes
    return sorted(votes, key=lambda x: x[0])


# def generate_symmetric__id_votes(num_agents=None, params=None):
#
#     m = num_agents
#     n = num_agents
#
...
#
#     # order votes
#     votes_1 = sorted(votes, key=lambda x: x[0])
