...
if __name__ == "__main__":
    ...
    experiment.add_election_family(model='impartial_culture', color='grey', name='ic', size=10)

    experiment.add_election_family(model='urn_model', color='black', name='urn',
                                   params={'alpha': 0.2}, size=10)

    experiment.add_election_family(model='norm-mallows', color='blue', name='mallows',
