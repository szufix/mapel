...
if __name__ == "__main__":
    ...
    # paths
    experiment.add_family(election_model='unid', size=48, color='black')
    experiment.add_family(election_model='anid', size=36, color='black')
    experiment.add_family(election_model='stid', size=23, color='black')
    experiment.add_family(election_model='anun', size=23, color='black')
    experiment.add_family(election_model='stun', size=36, color='black')
    experiment.add_family(election_model='stan', size=39, color='black')
