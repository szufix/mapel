...
if __name__ == "__main__":
    ...
    experiment.add_election_family(model='approval_ic', color='grey', name='ic0.5',
                                   params={'p': 0.5}, size=10)

    experiment.add_election_family(model='approval_ic', color='black', name='ic0.25',
                                   params={'p': 0.25}, size=10)

    experiment.add_election_family(model='approval_ic', color='blue', name='ic0.75',
