...
if __name__ == "__main__":
    ...
    experiment.add_family(model_id='impartial_culture', color='grey', family_id='ic',
                                   size=10)

    experiment.add_family(model_id='urn_model', color='black', family_id='urn',
                                   params={'alpha': 0.2}, size=10)

    experiment.add_family(model_id='norm-mallows', color='blue', family_id='mallows',
